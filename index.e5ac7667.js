...
var _mouseTracker = require("./mouse_tracker");
var _mouseTrackerDefault = parcelHelpers.interopDefault(_mouseTracker);
var _textShuffle = require("./text_shuffle");
var _textShuffleDefault = parcelHelpers.interopDefault(_textShuffle);
var _settings = require("./settings");
var _settingsDefault = parcelHelpers.interopDefault(_settings);
var _formBtn = require("./form_btn");
var _formBtnDefault = parcelHelpers.interopDefault(_formBtn);
...
if (localStorage.getItem("skip") === "false") starting_btn.onclick = function() {
...
function contentLoad() {
    ...
    ;
    first_panel.classList.add("animate__animated", "animate__fadeIn", "reveal");
    second_panel.classList.remove("opacity", "height", "padding") //showing second panel
    ;
    second_panel.classList.add("animate__animated", "animate__fadeIn", "reveal");
    third_panel.classList.remove("opacity", "height", "padding") //showing third panel
    ;
    third_panel.classList.add("animate__animated", "animate__fadeIn", "reveal");
    fourth_panel.classList.remove("opacity", "height", "padding") //showing fourth panel
    ;
    fourth_panel.classList.add("animate__animated", "animate__fadeIn", "reveal");
...
},{"./mouse_tracker":"1YhIf","./text_shuffle":"6gdpo","./settings":"9e2nb","./form_btn":"6F5BB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1YhIf":[function(require,module,exports) {
...
document.addEventListener("mousedown", ()=>{
    cursor.classList.remove("mouse-up");
    if (cursor.classList.contains("mouse-down") == false) cursor.classList.add("mouse-down");
});
document.addEventListener("mouseup", ()=>{
    cursor.classList.remove("mouse-down");
    if (cursor.classList.contains("mouse-up") == false) cursor.classList.add("mouse-up");
});
addEventListener("click", ()=>{});
if (cursor.classList.contains("mouse-click") == false) cursor.classList.toggle("mouse-click");
a.forEach((item)=>{
    item.addEventListener("mouseover", ()=>{
        cursorinner.classList.add("inner-circle-hover");
    });
    item.addEventListener("mouseleave", ()=>{
        cursorinner.classList.remove("inner-circle-hover");
    });
});
//cursor animations
...
},{}],"9e2nb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let intro_panel = document.querySelector(".intro-panel");
let first_panel = document.querySelector(".first-panel");
...
let nav = document.querySelector("nav");
let footer = document.querySelector("footer");
let checkbox = document.querySelector(".skip-checkbox");
let starting_btn = document.querySelector(".starting-btn");
if (localStorage.getItem("skip") == null) localStorage.setItem("skip", false);
else if (localStorage.getItem("skip") === "true") {
    checkbox.checked = true;
    skipAnimations();
} else checkbox.checked = false;
checkbox.addEventListener("change", (event)=>{
    if (event.currentTarget.checked) localStorage.setItem("skip", true);
    else localStorage.setItem("skip", false);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6F5BB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let submit_button = document.querySelector(".mail-submit-btn");
let spinner = document.querySelector(".spinner-div");
submit_button.addEventListener("click", ()=>{
    spinner.classList.toggle("hide");
    spinner.classList.toggle("show");
});
submit_button.addEventListener("focusout", ()=>{
    spinner.classList.toggle("hide");
    spinner.classList.toggle("show");
});
exports.default = self;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4PWRH","aitAD"], "aitAD", "parcelRequire7db1")
